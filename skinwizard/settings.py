...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication',  # For APIs
        'rest_framework.authentication.SessionAuthentication',  # For Browsable API login
    ],
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',
        'rest_framework.renderers.BrowsableAPIRenderer',  # Enables the browsable form interface
    ],
}


# dj-rest-auth & allauth settings
REST_USE_JWT = True  # Optional but common with frontend apps
...
# Media files (for uploaded pharmacy license images)
MEDIA_URL = '/media/'
